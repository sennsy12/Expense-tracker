   ...
   {/* Record Change Form */}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                         {/* Date Input with Label outside, flex with pointer for spacing, */}
                ...
                {/* Select input and Label for asset/liability.*/}
            <div  className="flex flex-col">
                 <label className="text-xs font-medium text-foreground/70 mb-1.5">
                   Asset/Liability
                </label>
       ...
       <optgroup label="Liabilities">
        ...
        <div className="flex gap-2">
              {/* Action Input with a Label for correct spacing. */}
...
{/* Summary Cards */}
     <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-6">
                <div className="p-3 rounded-lg bg-card/50 backdrop-blur border shadow-sm hover:shadow-md transition-shadow">
           ...
           <div className="col-span-2 sm:col-span-1 p-3 rounded-lg bg-card/50 backdrop-blur border shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-1.5">
