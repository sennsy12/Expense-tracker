...
export function NetWorthHistory() {
  ...
  const handleEdit = useCallback((entry: NetWorthEntry) => {
      setSelectedEntry(entry);
      setEditModalOpen(true);
    }, [setSelectedEntry, setEditModalOpen]);
  ...
  const closeModal = useCallback(() => {
    ...
    }, [setEditModalOpen, setSelectedEntry]);
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b bg-muted/50">
              <th className="text-left p-2 sm:p-3 text-xs font-medium text-muted-foreground">
                Date
              </th>
              <th className="text-left p-2 sm:p-3 text-xs font-medium text-muted-foreground">
                Asset
              ...
              <th className="text-right p-2 sm:p-3 text-xs font-medium text-muted-foreground">
                Change
              </th>
              <th className="text-right p-2 sm:p-3 text-xs font-medium text-muted-foreground">
                Net Worth
